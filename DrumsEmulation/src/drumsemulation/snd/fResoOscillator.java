 ...
 * @author immanuel
 */
public class fResoOscillator extends hitGenerator {
    ...
    public fResoOscillator(String description) {
        this();
        ...
        while (scan.hasNext()) {
            ...
            if (parm.contains("=")) {
                ...
                if (pname.equals("f")) {
                    ...
                    this.phase_frame = -(int) (((float) drumsemulation.DrumsEmulationApp.getApplication().getSampleRate() * poorInputParser.parseFloat(pval)) / 1000.0f);
